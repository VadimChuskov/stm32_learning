...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, LED_Pin|D_RES_Pin|D_DC_Pin|D_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(D_BL_GPIO_Port, D_BL_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : LED_Pin D_RES_Pin D_DC_Pin D_CS_Pin */
  GPIO_InitStruct.Pin = LED_Pin|D_RES_Pin|D_DC_Pin|D_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : D_BL_Pin */
  GPIO_InitStruct.Pin = D_BL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(D_BL_GPIO_Port, &GPIO_InitStruct);
